...
void mcd_poll() {
  ...
  if (req != last_req) {
    ...
    // printf("\x1b[32mMCD: Get command, command = %04X%04X%04X, has_command =
...
static int mcd_load_rom(const char *basename, const char *name, int sub_index) {
  ...
  if (p) {
    p++;
    strcpy(p, name);
    if (user_io_file_tx(buf, sub_index << 6))
      return 1;
  }
...
void mcd_set_image(int num, const char *filename) {
  ...
  int same_game =
      *filename && *last_dir && !strncmp(last_dir, filename, strlen(last_dir));
  ...
  if (!same_game) {
    ...
    loaded = 0;
    // use 'buf' which is static scope, avoid redeclaring 'p' if not necessary
    // or declare in new scope
    {
      char *p2 = strrchr(buf, '/');
      if (p2) {
...
static char int_blank[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F,
    0x5F, 0x5F, 0x5F, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x7D, 0x00, 0x7D,
    0x00, 0x7D, 0x00, 0x7D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x53, 0x45, 0x47, 0x41, 0x5F, 0x43, 0x44, 0x5F, 0x52, 0x4F, 0x4D, 0x00,
    0x01, 0x00, 0x00, 0x00, 0x52, 0x41, 0x4D, 0x5F, 0x43, 0x41, 0x52, 0x54,
...
static char ext_blank[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F,
    0x5F, 0x5F, 0x5F, 0x00, 0x00, 0x00, 0x00, 0x40, 0x1F, 0xFD, 0x1F, 0xFD,
    0x1F, 0xFD, 0x1F, 0xFD, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x53, 0x45, 0x47, 0x41, 0x5F, 0x43, 0x44, 0x5F, 0x52, 0x4F, 0x4D, 0x00,
    0x01, 0x00, 0x00, 0x00, 0x52, 0x41, 0x4D, 0x5F, 0x43, 0x41, 0x52, 0x54,
    0x52, 0x49, 0x44, 0x47, 0x45, 0x5F, 0x5F, 0x5F,
};
