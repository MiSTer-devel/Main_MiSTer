...
void mcd_poll() {
  ...
  if (!poll_timer || CheckTimer(poll_timer)) {
    ...
    if (has_command) {
      ...
      //			printf("\x1b[32mMCD: Send status, status =
      //%04X%04X%04X, frame = %u\n\x1b[0m", (uint16_t)((s >> 32) & 0x00FF),
      //(uint16_t)((s >> 16) & 0xFFFF), (uint16_t)((s >> 0) & 0xFFFF), frame);
    }
  ...
  if (req != last_req) {
    ...
    //		printf("\x1b[32mMCD: Get command, command = %04X%04X%04X,
    //has_command = %u\n\x1b[0m", data_in[2], data_in[1], data_in[0],
    //has_command);
  } else
    DisableIO();
}
...
static char int_blank[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x00,
    0x00, 0x00, 0x00, 0x40, 0x00, 0x7D, 0x00, 0x7D, 0x00, 0x7D, 0x00, 0x7D,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x53, 0x45, 0x47, 0x41,
    0x5F, 0x43, 0x44, 0x5F, 0x52, 0x4F, 0x4D, 0x00, 0x01, 0x00, 0x00, 0x00,
    0x52, 0x41, 0x4D, 0x5F, 0x43, 0x41, 0x52, 0x54, 0x52, 0x49, 0x44, 0x47,
    0x45, 0x5F, 0x5F, 0x5F,
};
...
static char ext_blank[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x5F, 0x00,
    0x00, 0x00, 0x00, 0x40, 0x1F, 0xFD, 0x1F, 0xFD, 0x1F, 0xFD, 0x1F, 0xFD,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x53, 0x45, 0x47, 0x41,
    0x5F, 0x43, 0x44, 0x5F, 0x52, 0x4F, 0x4D, 0x00, 0x01, 0x00, 0x00, 0x00,
    0x52, 0x41, 0x4D, 0x5F, 0x43, 0x41, 0x52, 0x54, 0x52, 0x49, 0x44, 0x47,
    0x45, 0x5F, 0x5F, 0x5F,
